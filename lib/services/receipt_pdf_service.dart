...
class ReceiptPdfService {
            ...
            child: pw.Column(
              ...
              children: [
                ...
                _amountRow(
                  ...
                  bold: true,
                  color: r.remainingAfter > 0 ? PdfColors.orange700 : PdfColors.green700,
                ),
  ...
  // ─────────────────────────────────────────────────────
  // Generate PDF, upload to Supabase storage, and
  // update payment_receipts.receipt_pdf_url in the DB.
  ...
  static Future<String?> generateAndUpload(PaymentReceipt r) async {
    try {
      ...
      // Update DB row with the storage path
      await _db
